...
def noun_incorrect_3():
    ...
    attempt_1 = cs50.run(f"python3 {SCRIPT_NAME}").stdin("n").stdin("gh").stdin("ghighi\n").stdout("How do you translate necklace to Klingon? You have 2 attempts left.").stdout("Hint: g___h").stdout("asdas")
    print(attempt_1)
